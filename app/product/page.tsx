...
const page = () => {
    ...
    return (
        <div className='mt-9 max-w-[1200px] mx-auto px-4 md:px-[50px] bg-amber-100 relative'>
            <StickyProductHeader product={product} />
            <div className="flex flex-col md:flex-row relative">
                {/* Left side */}
                {/* <div className="w-full md:w-1/2 lg:w-[65%] bg-lime-200">
                    <div className="flex items-center justify-center">
                        <div className="h-[500px] w-[333px] bg-gray-300">image</div>
                    </div>
                    <div className="grid place-items-center grid-cols-1 lg:grid-cols-2 p-[15px] gap-x-4 xl:gap-x-5 gap-y-2">
                        {Array.from({ length: 9 }).map((_, index) => (
                            <div key={index} className="h-[500px] w-[333px] lg:w-full bg-gray-300">image</div>
                        ))}
                ...
                {/* Right side */}
                <div className="w-full md:w-1/2 lg:w-[35%] bg-rose-200">
                    <div className="md:sticky md:top-10 md:pl-10 bg-purple-300">
