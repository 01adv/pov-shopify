...
//     process.env.NEXT_PUBLIC_FASTAPI_URL || "http://localhost:8000"; // Add to .env
...
//   try {
//     const response = await fetch(`${fastApiBaseUrl}/log`, {
//       method: "POST",
//       headers: { "Content-Type": "application/json" },
//       body: JSON.stringify({
//         sessionId,
...
//         const retryResponse = await fetch(`${fastApiBaseUrl}/log`, {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
//           body: JSON.stringify({
//             sessionId,
